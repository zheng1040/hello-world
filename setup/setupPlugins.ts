...
import AggPivotTable from '../aggregation/controlPanels/PivotTable';
...
export default function setupPlugins() {
  ...
  getChartControlPanelRegistry()
    ...
    .registerValue('agg_pivot_table', AggPivotTable);
  
  const registry = getChartMetadataRegistry();
  registry
    .registerValue('agg_pivot_table', new ChartMetadata({
      name: 'agg_pivot_table',
      thumbnail: '',
    }))
